...
#define SLI_ZIGBEE_PRIMARY_NETWORK_DEVICE_TYPE       SLI_ZIGBEE_NETWORK_DEVICE_TYPE_END_DEVICE
...
#define SLI_ZIGBEE_PRIMARY_NETWORK_SECURITY_TYPE     SLI_ZIGBEE_NETWORK_SECURITY_TYPE_4_0
