  ...
  sl_zigbee_dlk_ecc_test_vector_bundle_t *vector_data)
{
  ...
  dlk_ecc_ctx->test = malloc(sizeof(sl_zigbee_dlk_ecc_test_vector_bundle_t));
  memcpy(dlk_ecc_ctx->test, vector_data, sizeof(sl_zigbee_dlk_ecc_test_vector_bundle_t));
  return SL_STATUS_OK;
}
