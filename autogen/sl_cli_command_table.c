...
static const sl_cli_command_info_t cli_cmd_bdb_hyphen_rejoin_enable = \
  SL_CLI_COMMAND(sl_zigbee_af_bdb_3dot1_rejoin_algorithm_enable_command,
                 "Enable or disable the rejoin algorithm. Disabling the algorithm will cause the End Device Support plugin to handle rejoins on end devices when connectivity is lost.",
                  "Enable (1) or disable (0) the rejoin algorithm" SL_CLI_UNIT_SEPARATOR,
                 {SL_CLI_ARG_UINT8, SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_bdb_hyphen_rejoin_status = \
  SL_CLI_COMMAND(sl_zigbee_af_bdb_3dot1_rejoin_algorithm_status_command,
                 "Display info about the rejoin algorithm",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_info_t cli_cmd_tc_hyphen_keepalive_now = \
  SL_CLI_COMMAND(sl_zigbee_af_send_keepalive_now_command,
                 "Send a TC Keepalive now. If the TC Keepalive server hasn't been discovered yet, a Match Descriptor is sent first",
                  "",
                 {SL_CLI_ARG_END, });

static const sl_cli_command_info_t cli_cmd_tc_hyphen_keepalive_halt = \
  SL_CLI_COMMAND(sl_zigbee_af_send_keepalive_halt_command,
                 "Halts the TC Keepalive mechanism",
                  "",
                 {SL_CLI_ARG_END, });
...
static const sl_cli_command_entry_t bdb_hyphen_rejoin_group_table[] = {
  { "enable", &cli_cmd_bdb_hyphen_rejoin_enable, false },
  { "status", &cli_cmd_bdb_hyphen_rejoin_status, false },
  { NULL, NULL, false },
};
static const sl_cli_command_info_t cli_cmd_grp_bdb_hyphen_rejoin = \
  SL_CLI_COMMAND_GROUP(bdb_hyphen_rejoin_group_table, "bdb-rejoin related commands");
...
static const sl_cli_command_entry_t tc_hyphen_keepalive_group_table[] = {
  { "now", &cli_cmd_tc_hyphen_keepalive_now, false },
  { "halt", &cli_cmd_tc_hyphen_keepalive_halt, false },
  { NULL, NULL, false },
};
