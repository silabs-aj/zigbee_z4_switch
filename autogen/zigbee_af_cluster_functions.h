...
void sl_zigbee_af_keepalive_cluster_client_default_response_cb (uint8_t endpoint, uint8_t commandId, sl_zigbee_af_status_t status);
...
#define GENERATED_FUNCTION_STRUCTURES_ARRAY  { \
  ...
  {\
    ...
    (sl_zigbee_af_generic_cluster_function_t)sl_zigbee_af_keepalive_cluster_client_default_response_cb\
  },\
  { 0x8000u,\
    0x00u,\
...
int clust_37_client_default_response_function;
};
